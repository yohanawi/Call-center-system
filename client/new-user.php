...
<head>
    ...
    <title>Call-center | Create User</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                ...
                                <label for="checkbox-signup"> Agree to condition </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" name="submit">Register</button>
                        </div>
                    </div>
                    <center>Already you have an account ? | <a href="./clogin.php">Sign In</a></center>
                </form>
            </div>
        </div>
    </section>
