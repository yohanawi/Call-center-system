<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="#" class="waves-effect"><i data-icon="p" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Users<span class="fa arrow"></span></span></a>
                <ul class="nav nav-second-level">
                    <li><a href="manage-user.php">Manage Users</a></li>
                    <li><a href="access.php">Users Access</a></li>
                </ul>
            </li>
            <li><a href="log.php" class="waves-effect"><i data-icon="1" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Call log</a></li>
            <li><a href="manage-ticket.php" class="waves-effect"><i data-icon="p" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Manage-Ticket</a></li>
