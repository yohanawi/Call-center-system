...
<head>
    ...
    <title>Call-center | Call log</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            ?>
                            <h3 class="box-title m-b-0">Call log ( <x style="color: orange;"><?php echo mysqli_num_rows($query_phone); ?></x> )</h3>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    while ($row = mysqli_fetch_array($query_phone)) {
                                        // $id = $row["id"]
                                        echo '
                                                    <tr>
                                                        <td>' . $row["number"] . '</td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h4 class="modal-title">Are you sure you want to delete this log?</h4>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <form action="functions/log_del.php" method="post">
