...
<body>
                                                        ...
                                                        <div class="form-actions">
                                                            <div class="post col-md-12">
                                                                <div class="user-profile-pic-wrapper">
                                                                    <div class="user-profile-pic-normal"> <img width="35" height="35" data-src-retina="../client/assets/img/admin.png" data-src="../client/assets/img/admin.png" src="../client/assets/img/admin.png" alt="Admin"> </div>
                                                                </div>
                                                                <div class="info-wrapper">
                                                                    <form action="functions/update.php" method="post">
                                                                        <br>
                                                                        <textarea name="admin_remark" cols="50" rows="2" required="true"><?php echo $row['admin_remark']; ?></textarea>
                                                                        <hr>
                                                                        <p class="small-text">
                                                                            <input name="edit" type="submit" class="btn btn-success waves-effect waves-light m-r-5" id="Update" value="update" size="20" />
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="../client/assets/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>

    <!-- END PAGE LEVEL PLUGINS -->
    <script src="../client/assets/js/support_ticket.js" type="text/javascript"></script>
</body>
